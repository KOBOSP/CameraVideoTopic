...
if(NOT "/home/kobosp/SLMAC/CameraVideoTopic/build/devel/include " STREQUAL " ")
  set(CameraVideoTopic_INCLUDE_DIRS "")
  set(_include_dirs "/home/kobosp/SLMAC/CameraVideoTopic/build/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'CameraVideoTopic' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kobosp/SLMAC/CameraVideoTopic/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/kobosp/SLMAC/CameraVideoTopic/build/devel/lib;/opt/ros/noetic/lib)
